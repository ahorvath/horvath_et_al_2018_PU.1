...
denovo.veh <- read.table("boxplots/mm_BMDM_control_Pol_II_S5_CS1368_S1_on_denovo_PolII_any_up_pos.tsv")
labeled.veh <- read.table("boxplots/mm_BMDM_control_Pol_II_S5_CS1368_S1_on_labeled_PolII_any_up_pos.tsv")
poised.veh <- read.table("boxplots/mm_BMDM_control_Pol_II_S5_CS1368_S1_on_poised_PolII_any_up_pos.tsv")
const.veh <- read.table("boxplots/mm_BMDM_control_Pol_II_S5_CS1368_S1_on_const_PolII_any_up_pos.tsv")

denovo.IL4 <- read.table("boxplots/mm_BMDM_IL4_1hr_PoI_II_S5_CS1369_S1_on_denovo_PolII_any_up_pos.tsv")
labeled.IL4 <- read.table("boxplots/mm_BMDM_IL4_1hr_PoI_II_S5_CS1369_S1_on_labeled_PolII_any_up_pos.tsv")
poised.IL4 <- read.table("boxplots/mm_BMDM_IL4_1hr_PoI_II_S5_CS1369_S1_on_poised_PolII_any_up_pos.tsv")
const.IL4 <- read.table("boxplots/mm_BMDM_IL4_1hr_PoI_II_S5_CS1369_S1_on_const_PolII_any_up_pos.tsv")
...
ggsave(gg, filename = "boxplot_PolII_S5_on_any_subclasses.pdf", width = 8)
